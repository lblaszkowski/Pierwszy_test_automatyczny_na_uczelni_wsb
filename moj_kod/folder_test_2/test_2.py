...
class TestWSB(unittest.TestCase):
    ...
    def test_redirect(self):
        ...
        # driver.get_screenshot_as_file('C:/wsb_tester/selenium_python/screen/'+'1.png')
        ...
        # driver.get_screenshot_as_file('C:/wsb_tester/selenium_python/screen/'+'2.png')
        driver.switch_to.window(main_page)
        driver.execute_script("window.open('');")
        # driver.execute_script("$(window.open(''))")
        ...
        # driver.get_screenshot_as_file('C:/wsb_tester/selenium_python/screen/'+'3.png')
        driver.switch_to.window(main_page)
        driver.get_screenshot_as_file(os.getcwd() + '\\' + '0.png')
        # driver.get_screenshot_as_file('C:/wsb_tester/selenium_python/screen/'+'0.png')
